...
texts:
    ...
    - title: "Primary Box Example"
      ...
      class: primary
    - title: "Secondary Box"
      content: "Another example with secondary styling, perfect for complementary information."
      class: secondary
    - title: "Success Box"
    ...
    - title: "Info Box"
      ...
      class: info
    - title: "No Box Style"
      content: "This text has no box styling (class: none), ideal for clean, borderless columns that blend seamlessly with the page."
      class: none
---